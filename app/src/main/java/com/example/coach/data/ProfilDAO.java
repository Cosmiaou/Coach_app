...
public class ProfilDAO extends SQLiteOpenHelper {
    ...
    /**
     * Constructeur. Appele le constructeur de la classe mère (SQLiteOpenHelper)
     * @param context
     */
    ...
    /**
     * Si la table n'existe pas, crée la table en fonction des constantes de classe
     * COL_DATEMESURE est la clé primaire. Stocké en timestamp au format SQLite INTEGER
    ...
    /**
     * Se déclenche automatiquement en cas de changement de DATABASE_VERSION. Supprime la table et appelle onCreate()
     * @param db The database.
    ...
    /**
     * Insère le profil envoyé en paramètre dans la BdD
     * @param profil
     */
    ...
    /**
     * Retourne le dernier profil envoyé dans la BdD
     * S'il n'en trouve pas, retourne un profil null
     * @return Profil
     */
